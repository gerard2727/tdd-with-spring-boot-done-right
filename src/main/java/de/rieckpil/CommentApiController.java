...
public class CommentApiController {
  ...
  @PostMapping
  public ResponseEntity<Void> createComment(@Valid @RequestBody CommentCreationRequest request,
                                            Authentication authentication,
                                            UriComponentsBuilder uriComponentsBuilder){

    UUID newCommentId = commentService.createComment(request, authentication.getName());
